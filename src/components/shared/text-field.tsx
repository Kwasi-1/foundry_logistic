  ...
  return (
    <div>
      <Select
        ...
        classNames={{
          trigger: cn(
            `data-[hover=true]:shadow-none shadow-none border dark:border-[#F5F5F580] border-[1px] bg-primary-gray/20 dark:bg-secondary-black rounded-md text-[12px]`,
            className,
          ),
...
export const CustomInputTextField = (props: CustomInputTextFieldProps) => {
  ...
  // Fallback to NextUI Input for outside label placement
  return (
    <div>
      <div className="relative">
        {isLoading && (
        ...
        <Input
          ...
          classNames={{
            ...
            inputWrapper: cn(
              "border dark:border-[#F5F5F580] bg-primary-gray/20 dark:bg-secondary-black focus-visible:ring-primary-green disabled:cursor-not-allowed disabled:opacity-50 rounded-md",
              height,
            ),
            label: "dark:text-gray-300 text-xs capitalize",
          }}
        />
      </div>
