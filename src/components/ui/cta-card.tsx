  ...
  "rounded-lg p-6 transition-all duration-200",
  {
    variants: {
      variant: {
        ...
        gradient: "bg-gradient-to-br from-primary to-primary/80 text-primary-foreground hover:shadow-lg",
    ...
    <div className={cn(ctaCardVariants({ variant }), className)} {...props}>
      <div className="flex items-start justify-between gap-4">
        <div className="flex-1 space-y-2">
          ...
          <p className={cn(
            "text-sm",
            isPrimaryVariant ? "text-primary-foreground/80" : "text-muted-foreground"
          )}>
            {subtitle}
          </p>
        </div>
